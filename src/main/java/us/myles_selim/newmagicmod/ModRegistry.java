...
import us.myles_selim.newmagicmod.ingredients.stack.special.JebWoolIngredient;
...
import us.myles_selim.newmagicmod.items.ItemSpawnPotion;
import us.myles_selim.newmagicmod.recipes.ISpellRecipe;
import us.myles_selim.newmagicmod.recipes.StackSpellRecipe;
...
public class ModRegistry {
	...
	public static void registerCommonRegistries(RegistryEvent.NewRegistry event) {
		...
		ModRegistries.SPELL_RECIPES = new RegistryBuilder<ISpellRecipe>().setType(ISpellRecipe.class)
				.setName(new ResourceLocation(NewMagicMod.MOD_ID, "spell_recipes")).create();
	}
	...
	public static void registerSpellRecipes(RegistryEvent.Register<ISpellRecipe> event) {
		...
		registry.register(new StackSpellRecipe(new ItemStack(ModItems.SPAWN_POTION),
				...
				ModIngredients.JEB_WOOL).setRegistryName("spawn_potion"));
	}
