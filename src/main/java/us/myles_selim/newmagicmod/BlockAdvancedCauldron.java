...
public class BlockAdvancedCauldron extends BlockContainer {
	...
	protected BlockAdvancedCauldron() {
		super(Material.IRON, MapColor.STONE);
		this.setRegistryName("advanced_cauldron");
		this.setUnlocalizedName(NewMagicMod.MOD_ID + ":advanced_cauldron");
	}

	@Override
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		return new TileAdvancedCauldron();
	}
